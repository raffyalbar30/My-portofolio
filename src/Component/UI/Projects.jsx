 ...
 <>
      ...
      <div className="grid grid-cols-1 laptop:grid-cols-2 laptop:gap-6 gap-1 p-4 mt-10 group ">
            <div className='w-full place-content-center bg-zinc-950 border border-white/[0.2] rounded-md p-8 '>
                    ...
                    <ContainProject>
                        <h1 className='text-2xl text-white pt-5 pb-2 font-semibold'>Coffeeshop UMKM Cilamaya</h1>
                              <h1 className='text-2xl text-white pb-2 font-semibold'>Project Menager & Front end Developer</h1>
                              <div className='w-full border bottom-1'></div>
                              <div className='pt-4'>
                                  <p className='text-justify text-white laptop:text-sm z-10'>The Coffeeshop Project was a
                                      ...
                                      and Redux Toolkit for handling payments and cart features.</p>
                                  ...
                                  <div className='flex justify-center laptop:justify-normal mt-4 mb-4'>
            ...
            <div className='w-full place-content-center bg-zinc-950 border border-white/[0.2] rounded-md p-8 '>
                    ...
                    <ContainProject>
                        <h1 className='text-2xl text-white pt-5 pb-2 font-semibold'>Perintis Computer Karawang</h1>
                              <h1 className='text-2xl text-white pb-2 font-semibold'>Front end web developer</h1>
                              <div className='w-full border bottom-1'></div>
                              <div className='pt-4'>
                                  <p className='text-justify text-white laptop:text-sm z-10'>In my first project, 
                                    I learned many lessons through collaboration with the team, communication, and of course, 
                                    code cleaning. This project was created during my internship at a computer company in Karawang,
                                     where I worked as a front-end developer with the team at Perintis Computer Karawang. The technologies 
                                     used in this internship included PHP for the back end, MySQL for the database,
                                     and for the user interface, we used HTML, CSS, Sass, Bootstrap, and pure JavaScript.</p>
                                  <div className='flex justify-center laptop:justify-normal gap-x-4 pt-4'>
