        ...
        <div className='cursor-pointer pb-4 laptop:mt-4'>
         ...
         <div className="md:w-32 md:h-[6px] h-1 bg-purple-200 rounded-full translate-x-1 w-auto"></div>
          ...
          <div className='absolute right-2 tablet:mt-12 laptop:mr-4 laptop:hidden'>
             <img src="/public/img/aboutme.png" alt="" className='w-44 laptop:w-[300px] ipad:hidden handphone:mt-12 iphone:mt-12 iphone:w-36 tablet:mt-4'/>
          </div>
         </div>
          <div className='flex justify-center laptop:items-center laptop:mt-4 mt-12 z-20'>
                <div className='laptop:pb-12'>
                   <h1 className='text-purple-500 laptop:text-4xl tablet:text-4xl text-2xl font-sans pb-2 font-bold laptop:text-left laptop:ml-4 underline underline-offset-4 ml-2'>Introduction</h1>
                     <p className='text-gray-400 text-justify laptop:px-4 font-sans tablet:text-lg laptop:text-xl text-[12px] pr-6 pl-2'>I am a fresh graduate from SMKN 1 BANYUSARI in the Software Engineering Department. 
                        ...
                        During school, I honed critical thinking skills, problem-solving abilities, and communication skills.
                         ...
                         <div className='flex gap-x-4 px-8 pt-4 laptop:px-8'>
                   {
                        sosial.map((item, i)=>{
                        ...
                        <div className='px-4 pt-4 laptop:pt-4 handphone:ml-2 laptop:px-4 group flex'>
                           <a className='laptop:px-20 py-2 tablet:py-4 handphone:px-12 rounded-md border  cursor-pointer flex items-center gap-x-2 group-hover:scale-110 duration-200 transition  !border-purple-400  hover:bg-indigo-500/10'>💼 Download CV <span className='opacity-0 group-hover:opacity-100 '> <FaDownload /></span></a>
                        </div>
                </div>
